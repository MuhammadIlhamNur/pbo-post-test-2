...
public final class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("4. Tambah makanan");
            System.out.println("5. Tampilkan informasi");
            System.out.println("6. Perbarui informasi");
            System.out.println("7. Hapus informasi");
